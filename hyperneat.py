...
class artist(_object):
    ...
    def isvalid(self): return _hyperneat.artist_isvalid(self)
    def clear(self): return _hyperneat.artist_clear(self)
    ...
    def map(self): return _hyperneat.artist_map(self)
